...
def generate_traindata_for_train(
    traindata_all,
    traindata_label,
    input_size,
    label_size,
            ...
            if valid > 0:
                ...
                sum_diff = np.sum(
                    np.abs(
                        image_center
                        - np.squeeze(
                            image_center[int(0.5 * input_size), int(0.5 * input_size)]
                        )
                    )
                )
...
def data_augmentation_for_train(
    traindata_batch_90d,
    traindata_batch_0d,
    traindata_batch_45d,
    traindata_batch_m45d,
    ...
    for batch_i in range(batch_size):
        ...
        traindata_batch_90d[batch_i, :, :, :] = pow(
            traindata_batch_90d[batch_i, :, :, :], gray_rand
        )
        traindata_batch_0d[batch_i, :, :, :] = pow(
            traindata_batch_0d[batch_i, :, :, :], gray_rand
        )
        traindata_batch_45d[batch_i, :, :, :] = pow(
            traindata_batch_45d[batch_i, :, :, :], gray_rand
        )
        traindata_batch_m45d[batch_i, :, :, :] = pow(
            traindata_batch_m45d[batch_i, :, :, :], gray_rand
        )
        ...
        if rotation_or_transp_rand == 4:
            traindata_batch_90d_tmp6 = np.copy(
                np.transpose(
                    np.squeeze(traindata_batch_90d[batch_i, :, :, :]), (1, 0, 2)
                )
            )
            traindata_batch_0d_tmp6 = np.copy(
                np.transpose(
                    np.squeeze(traindata_batch_0d[batch_i, :, :, :]), (1, 0, 2)
                )
            )
            traindata_batch_45d_tmp6 = np.copy(
                np.transpose(
                    np.squeeze(traindata_batch_45d[batch_i, :, :, :]), (1, 0, 2)
                )
            )
            traindata_batch_m45d_tmp6 = np.copy(
                np.transpose(
                    np.squeeze(traindata_batch_m45d[batch_i, :, :, :]), (1, 0, 2)
                )
            )

            traindata_batch_0d[batch_i, :, :, :] = np.copy(
                traindata_batch_90d_tmp6[:, :, ::-1]
            )
            traindata_batch_90d[batch_i, :, :, :] = np.copy(
                traindata_batch_0d_tmp6[:, :, ::-1]
            )
            traindata_batch_45d[batch_i, :, :, :] = np.copy(
                traindata_batch_45d_tmp6[:, :, ::-1]
            )
            traindata_batch_m45d[batch_i, :, :, :] = np.copy(
                traindata_batch_m45d_tmp6
            )  # [:,:,::-1])
        ...
        if rotation_or_transp_rand == 1:  # 90도
            traindata_batch_90d_tmp3 = np.copy(
                np.rot90(traindata_batch_90d[batch_i, :, :, :], 1, (0, 1))
            )
            traindata_batch_0d_tmp3 = np.copy(
                np.rot90(traindata_batch_0d[batch_i, :, :, :], 1, (0, 1))
            )
            traindata_batch_45d_tmp3 = np.copy(
                np.rot90(traindata_batch_45d[batch_i, :, :, :], 1, (0, 1))
            )
            traindata_batch_m45d_tmp3 = np.copy(
                np.rot90(traindata_batch_m45d[batch_i, :, :, :], 1, (0, 1))
            )
            ...
            traindata_batch_m45d[batch_i, :, :, :] = traindata_batch_45d_tmp3[
                :, :, ::-1
            ]
        ...
        if rotation_or_transp_rand == 2:  # 180도
            traindata_batch_90d_tmp4 = np.copy(
                np.rot90(traindata_batch_90d[batch_i, :, :, :], 2, (0, 1))
            )
            traindata_batch_0d_tmp4 = np.copy(
                np.rot90(traindata_batch_0d[batch_i, :, :, :], 2, (0, 1))
            )
            traindata_batch_45d_tmp4 = np.copy(
                np.rot90(traindata_batch_45d[batch_i, :, :, :], 2, (0, 1))
            )
            traindata_batch_m45d_tmp4 = np.copy(
                np.rot90(traindata_batch_m45d[batch_i, :, :, :], 2, (0, 1))
            )
            ...
            traindata_batch_m45d[batch_i, :, :, :] = traindata_batch_m45d_tmp4[
                :, :, ::-1
            ]
        ...
        if rotation_or_transp_rand == 3:  # 270도
            traindata_batch_90d_tmp5 = np.copy(
                np.rot90(traindata_batch_90d[batch_i, :, :, :], 3, (0, 1))
            )
            traindata_batch_0d_tmp5 = np.copy(
                np.rot90(traindata_batch_0d[batch_i, :, :, :], 3, (0, 1))
            )
            traindata_batch_45d_tmp5 = np.copy(
                np.rot90(traindata_batch_45d[batch_i, :, :, :], 3, (0, 1))
            )
            traindata_batch_m45d_tmp5 = np.copy(
                np.rot90(traindata_batch_m45d[batch_i, :, :, :], 3, (0, 1))
            )

            traindata_batch_90d[batch_i, :, :, :] = traindata_batch_0d_tmp5[:, :, ::-1]
            traindata_batch_0d[batch_i, :, :, :] = traindata_batch_90d_tmp5
            traindata_batch_45d[batch_i, :, :, :] = traindata_batch_m45d_tmp5[
                :, :, ::-1
            ]
...
def generate_traindata512(traindata_all, traindata_label, Setting02_AngualrViews):
    ...
    for ii in range(0, len(traindata_all)):
        ...
        traindata_batch_0d[ii, :, :, :] = np.squeeze(
            ...
            * traindata_all[
                image_id : image_id + 1,
                idx_start : idx_start + input_size,
                idy_start : idy_start + input_size,
                4 + ix_rd,
                seq0to8,
                0,
            ].astype("float32")
