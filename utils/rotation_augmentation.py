...
def rotation_augmentation(
    seq_90d_batch, seq_0d_batch, seq_45d_batch, seq_M45d_batch, label_batch, batch_size
):
    for batch_i in range(batch_size):
        ...
        if transp_rand == 1:  # transpose
            seq_90d_batch_tmp6 = np.copy(
                np.transpose(np.squeeze(seq_90d_batch[batch_i, :, :, :]), (1, 0, 2))
            )
            seq_0d_batch_tmp6 = np.copy(
                np.transpose(np.squeeze(seq_0d_batch[batch_i, :, :, :]), (1, 0, 2))
            )
            seq_45d_batch_tmp6 = np.copy(
                np.transpose(np.squeeze(seq_45d_batch[batch_i, :, :, :]), (1, 0, 2))
            )
            seq_M45d_batch_tmp6 = np.copy(
                np.transpose(np.squeeze(seq_M45d_batch[batch_i, :, :, :]), (1, 0, 2))
            )
            ...
            label_batch[batch_i, :, :] = np.copy(
                np.transpose(label_batch[batch_i, :, :], (1, 0))
            )

        if rot90_rand == 1:  # 90 degree
            seq_90d_batch_tmp3 = np.copy(
                np.rot90(seq_90d_batch[batch_i, :, :, :], 1, (0, 1))
            )
            seq_0d_batch_tmp3 = np.copy(
                np.rot90(seq_0d_batch[batch_i, :, :, :], 1, (0, 1))
            )
            seq_45d_batch_tmp3 = np.copy(
                np.rot90(seq_45d_batch[batch_i, :, :, :], 1, (0, 1))
            )
            seq_M45d_batch_tmp3 = np.copy(
                np.rot90(seq_M45d_batch[batch_i, :, :, :], 1, (0, 1))
            )
            ...
            label_batch[batch_i, :, :] = np.copy(
                np.rot90(label_batch[batch_i, :, :], 1, (0, 1))
            )

        if rot90_rand == 2:  # 180 degree
            seq_90d_batch_tmp4 = np.copy(
                np.rot90(seq_90d_batch[batch_i, :, :, :], 2, (0, 1))
            )
            seq_0d_batch_tmp4 = np.copy(
                np.rot90(seq_0d_batch[batch_i, :, :, :], 2, (0, 1))
            )
            seq_45d_batch_tmp4 = np.copy(
                np.rot90(seq_45d_batch[batch_i, :, :, :], 2, (0, 1))
            )
            seq_M45d_batch_tmp4 = np.copy(
                np.rot90(seq_M45d_batch[batch_i, :, :, :], 2, (0, 1))
            )
            ...
            label_batch[batch_i, :, :] = np.copy(
                np.rot90(label_batch[batch_i, :, :], 2, (0, 1))
            )

        if rot90_rand == 3:  # 270 degree
            seq_90d_batch_tmp5 = np.copy(
                np.rot90(seq_90d_batch[batch_i, :, :, :], 3, (0, 1))
            )
            seq_0d_batch_tmp5 = np.copy(
                np.rot90(seq_0d_batch[batch_i, :, :, :], 3, (0, 1))
            )
            seq_45d_batch_tmp5 = np.copy(
                np.rot90(seq_45d_batch[batch_i, :, :, :], 3, (0, 1))
            )
            seq_M45d_batch_tmp5 = np.copy(
                np.rot90(seq_M45d_batch[batch_i, :, :, :], 3, (0, 1))
            )
            ...
            label_batch[batch_i, :, :] = np.copy(
                np.rot90(label_batch[batch_i, :, :], 3, (0, 1))
            )
